...
function autoInicioCategoria(){
    ...
    $.ajax({
        url: "http://150.230.91.159:8080/api/Category/all",
        type: "GET",
        datatype:"JSON",
...
function guardarInformacionCategorias(){
    let var2 = {
        ...
        url:"http://150.230.91.159:8080/api/Category/save",
...
function borrarInformacionCategorias(idElemento){
    ...
    $.ajax({
        url:"http://150.230.91.159:8080/api/Category/"+idElemento,
        type:'DELETE',
        data:dataToSend,
...
function actualizarInformacionCategorias(idCategoria){
    ...
    $.ajax({
        url:"http://150.230.91.159:8080/api/Category/update",
        type:'PUT',
        data:dataToSend,
        contentType:'application/json',
        dataType: 'JSON', 
...
function traerInformacionClient(){
    $.ajax({
        url:"http://150.230.91.159:8080/api/Client/all",
        type:"GET",
        datatype:"JSON",
        success:function(response){
            //var myItems = response.items;
...
function guardarInformacionClient(){
    let var2 = {
        ...
        url:"http://150.230.91.159:8080/api/Client/save",
...
function borrarInformacionClient(idClient){
    ...
    $.ajax({
        url:"http://150.230.91.159:8080/api/Client/"+idClient,
        type:'DELETE',
        data:dataToSend,
        contentType:'application/JSON',
        dataType:'JSON',
...
function actualizarInformacionClient(idElemento){ 
    ...
    $.ajax({
        url:"http://150.230.91.159:8080/api/Client/update",
        type:'PUT',
        data:dataToSend,
        contentType:'application/json',
        dataType: 'JSON', 
...
function traerInformacionMessage(){
    $.ajax({
        url:"http://150.230.91.159:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
        success:function(response){
            //var myItems = response.items;
...
function guardarInformacionMessage(){
    let var2 = {
        ...
        url:"http://150.230.91.159:8080/api/Message/save",
...
function borrarInformacionMessage(idMessage){
    ...
    $.ajax({
        url:"http://150.230.91.159:8080/api/Message/"+idMessage,
        type:'DELETE',
        data:dataToSend,
        contentType:'application/JSON',
        dataType:'JSON',
...
function actualizarInformacionMessage(idElemento){ 
    ...
    $.ajax({
        url:"http://150.230.91.159:8080/api/Message/update",
        type:'PUT',
        data:dataToSend,
        contentType:'application/json',
        dataType: 'JSON', 
...
function guardarInformacionOrtopedic(){
    let var2 = {
        ...
        url:"http://150.230.91.159:8080/api/Ortopedic/save",
...
function borrarInformacionOrtopedic(idElemento){
    ...
    $.ajax({
        url:"http://150.230.91.159:8080/api/Ortopedic/"+idElemento,
        type:'DELETE',
        data:dataToSend,
        contentType:'application/JSON',
        dataType:'JSON',
...
function actualizarInformacionOrtopedic(idOrtopedic){
    ...
    $.ajax({
        url:"http://150.230.91.159:8080/api/Ortopedic/update",
        type:'PUT',
        data:dataToSend,
        contentType:'application/json',
        dataType: 'JSON', 
...
function traerInformacionReservation(){
    $.ajax({
        url:"http://150.230.91.159:8080/api/Reservation/all",
        type:"GET",
        datatype:"JSON",
        success:function(response){
            //var myItems = response.items;
...
function guardarInformacionReservation(){
    let var2 = {
        ...
        url:"http://150.230.91.159:8080/api/Reservation/save",
...
function borrarInformacionReservation(idElemento){
    ...
    $.ajax({
        url:"http://150.230.91.159:8080/api/Reservation/"+idElemento,
        type:'DELETE',
        data:dataToSend,
        contentType:'application/JSON',
        dataType:'JSON',
...
function actualizarInformacionReservation(idElemento){ 
    ...
    $.ajax({
        url:"http://150.230.91.159:8080/api/Reservation/update",
        type:'PUT',
        data:dataToSend,
        contentType:'application/json',
        dataType: 'JSON', 
